...
public class ChessMatch {
	...
	private void validateSourcePosition(Position position) {
		...
		if (!board.piece(position).isThereAnyPossibleMove()) {
			throw new ChessException("There is no possible moves to this selected piece!");
		}
	}

	private void validateTargetPosition(Position source, Position target) {
		if (!board.piece(source).possibleMove(target)) {
			throw new ChessException("This piece can not move to target position");
		}
	}
	...
	// uma peça da classe ChessPiece
	private void placeNewPiece(char column, int row, ChessPiece piece) {
		// chama o metodo da classe Board, instanciando um novo objeto da classe
		// ChessPosition passando a columa e linha
